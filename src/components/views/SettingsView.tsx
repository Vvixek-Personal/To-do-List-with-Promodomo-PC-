  ...
  return (
    <div className="w-full max-w-3xl mx-auto flex flex-col gap-6 font-detail">
      ...
      <div className="rounded-3xl border border-white/80 bg-white/70 backdrop-blur-2xl p-7 shadow-[0_14px_40px_rgba(30,40,90,0.06),inset_0_1px_2px_rgba(255,255,255,0.95)]">
        <span className="font-header text-xs font-bold tracking-wider uppercase text-[#3b5bfd]">PREFERENCES</span>
        <h2 className="font-header text-2xl font-bold text-[#0f172a] tracking-tight mt-1">Timer & App Settings</h2>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-4 rounded-2xl bg-white/80 border border-white/90 shadow-sm">
            ...
            <input
              ...
              className="w-full bg-[#f8fafc] border border-[#e2e8f0] rounded-xl px-3 py-2 text-[#0f172a] text-lg font-bold tabular-nums focus:outline-none focus:border-[#3b5bfd]"
            />
          </div>
