  ...
  return (
    <div className="w-full max-w-4xl mx-auto flex flex-col gap-6 font-sans">
      ...
      <div className="rounded-3xl border border-white/80 bg-white/70 backdrop-blur-2xl p-7 sm:p-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 shadow-[0_14px_40px_rgba(30,40,90,0.06),inset_0_1px_2px_rgba(255,255,255,0.95)]">
        <div>
          <span className="text-xs font-bold tracking-wider uppercase text-[#3b5bfd]">
            TODAY'S MOMENTUM
          </span>
          <h1 className="text-2xl sm:text-3xl font-bold text-[#0f172a] tracking-tight mt-1.5">
            Ready for deep focus
          </h1>
          <p className="text-xs sm:text-sm text-[#475569] mt-2 leading-relaxed max-w-lg">
            {activeTaskTitle 
        ...
        <button
          ...
          className="flex items-center gap-2.5 px-6 py-3.5 rounded-2xl bg-gradient-to-r from-[#3b5bfd] to-[#5b4eff] hover:from-[#324fdf] hover:to-[#4e40e6] text-white text-sm font-semibold shadow-[0_10px_25px_rgba(59,91,253,0.35)] transition-all transform hover:-translate-y-0.5 active:translate-y-0 cursor-pointer whitespace-nowrap"
        >
          {totalTasks === 0 ? (
            <>
        ...
        >
          <div className="flex items-center">
            <div className="w-14 h-14 rounded-2xl bg-[#eff6ff] border border-[#dbeafe] flex items-center justify-center flex-shrink-0 mr-4 shadow-sm">
              <CheckCircle2 className="w-7 h-7 text-[#3b82f6] stroke-[1.8]" />
            </div>
            <div>
              <div className="text-[11px] font-bold tracking-wider uppercase text-[#3b82f6]">
                COMPLETED POMS
              </div>
              <div className="text-3xl font-bold text-[#0f172a] mt-0.5">
                {totalPomsCompleted}
              </div>
        ...
        >
          <div className="flex items-center">
            <div className="w-14 h-14 rounded-2xl bg-[#ecfdf5] border border-[#d1fae5] flex items-center justify-center flex-shrink-0 mr-4 shadow-sm">
              <svg className="w-7 h-7 text-[#10b981]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div>
              <div className="text-[11px] font-bold tracking-wider uppercase text-[#10b981]">
                TASKS PROGRESS
              </div>
              <div className="text-3xl font-bold text-[#0f172a] mt-0.5">
        ...
        >
          <div className="flex items-center">
            <div className="w-14 h-14 rounded-2xl bg-[#fff7ed] border border-[#ffedd5] flex items-center justify-center flex-shrink-0 mr-4 shadow-sm">
              <Flame className="w-7 h-7 text-[#f97316] fill-[#f97316]/20 stroke-[1.8]" />
            </div>
            <div>
              <div className="text-[11px] font-bold tracking-wider uppercase text-[#ea580c]">
                FOCUS STREAK
              </div>
              <div className="text-3xl font-bold text-[#0f172a] mt-0.5">
      ...
      <div className="rounded-3xl border border-white/80 bg-white/70 backdrop-blur-2xl p-7 shadow-[0_14px_40px_rgba(30,40,90,0.06),inset_0_1px_2px_rgba(255,255,255,0.95)]">
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-lg font-bold text-[#0f172a]">Upcoming Tasks</h2>
          <button 
            onClick={onNavigateToPlanning}
            className="text-xs font-semibold text-[#3b5bfd] hover:text-[#2546db] flex items-center gap-1 transition-colors cursor-pointer"
          >
        ...
        {tasks.length === 0 ? (
          ...
          >
            <p className="text-sm font-semibold text-[#1e293b]">No tasks planned yet</p>
            <p className="text-xs text-[#64748b] mt-1">Click to create your first action item and assign estimated pomodoros.</p>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3.5 min-w-0">
                    ...
                    <span className={`text-sm font-medium truncate ${task.completed ? 'line-through text-[#94a3b8]' : 'text-[#1e293b]'}`}>
                      {task.title}
                    </span>
                  </div>
                  <span className={`text-xs font-semibold px-3 py-1.5 rounded-full ${badgeStyle} flex-shrink-0 ml-4`}>
